            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-12 col-lg-8">
                    <div class="_cvent_form_main">
                        <h2 class="_title2 _mar_b30">Add new event speakers.</h2>

                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="_input_group">
                                    <p class="_1label">Speaker name <span>*</span></p>

                                    <input v-model="data.name" class="_1int" type="text" placeholder="Type speaker name">
                                </div>
                            </div>

                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="_input_group">
                                    <p class="_1label">Speaker profession <span>*</span></p>

                                    <input v-model="data.profession" class="_1int" type="text" placeholder="Type speaker profession">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="_input_group">
                                    <p class="_1label">Speaker image</p>
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="_group_button">
                                    <button @click="addEventSpeaker" class="_btn3" type="button">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods : {
        async addEventSpeaker(){
            ...
            const res = await this.callApi('post', '/app/add_eventSpeaker', this.data)
			...
			if(res.status===201){
                ...
                this.s('Speakers has been added successfully!')

                this.$refs.speakerImage.clearFiles()
    ...
    created(){
        ...
        // console.log('yes', this.getEventId)
